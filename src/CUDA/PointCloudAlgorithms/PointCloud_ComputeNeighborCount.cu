...
//	}
//
//	if (centerVoxel->neighborCount < neighborCount)
//	{
//		centerVoxel->neighborCount = neighborCount;
//	}
//}
//
...
//}
//
//__global__ void Kernel_SerializeColoringByNeighborCount(HashMapInfo info, PointCloudBuffers buffers, unsigned int countThreshold)
//{
...
//
//	if (countThreshold < voxel->neighborCount)
//	{
...
//}
//
//void PointCloud::SerializeColoringByNeighborCount(unsigned int countThreshold, PointCloudBuffers& d_tempBuffers)
//{
...
//
//	Kernel_SerializeColoringByNeighborCount << <gridOccupied, blockSize >> > (hashmap.info, d_tempBuffers, countThreshold);
//
//	cudaDeviceSynchronize();
//}
