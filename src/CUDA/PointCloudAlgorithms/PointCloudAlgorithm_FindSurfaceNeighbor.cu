...
PointCloudAlgorithm_FindSurfaceNeighbor::PointCloudAlgorithm_FindSurfaceNeighbor()
{
...
void PointCloudAlgorithm_FindSurfaceNeighbor::RunAlgorithm(HostPointCloud* pointCloud)
{
	//nvtxRangePushA("Clustering");
